                    ...
                    <div class="col-sm-9 col-xs-12 padd-lr0">
                        <div class="wheel-top-menu clearfix">
                            <div class="wheel-top-menu-info">
                                ...
                                <div class="top-menu-item"><a href="#"><i class="fa fa-envelope"></i><span>contact@wgmail.com</span></a></div>
                            </div>
                            ...
                            <nav id="dl-menu">
                                ...
                                <ul class="main-menu dl-menu">
                                    <li class="menu-item   current-menu-parent menu-item-has-children   active-color ">
                                        ...
                                        <ul class="sub-menu dl-submenu">
                                            <li class="menu-item current-menu-item">
                                                <a href="index-2.html">Reservation</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="menu-item current-menu-parent menu-item-has-children  ">
                                        ...
                                        <ul class="sub-menu dl-submenu">
                                            <li class="menu-item current-menu-item">
                                                <a href="car-list-grid.html">1</a>
                                            </li>
                                            <li class="menu-item current-menu-item">
                                                <a href="car-list-3col2.html">2</a>
                                            </li>
                                            <li class="menu-item current-menu-item">
                                                <a href="car-listing-details.html">3</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="menu-item ">
                                    ...
                                    <li class="menu-item menu-item-has-children  ">
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="menu-item "><a href="shopping.html">Cart</a></li>
                                            <li class="menu-item menu-item-has-children">
                                                <a href="#">Level 2</a>
                                                <ul class="sub-menu">
                                    ...
                                    <li class="menu-item   ">
                                        <a href="reservation1.html">My Reservation</a>
                                    </li>
                                </ul>
...
<form action="process.php" method="post">
                            <div> <h3><b>MAKE YOUR RESERVATION</b></h3></div>
                            <label for="input                        -val11"><span>Destination</span>
                            <input type="text" name="destination" id='input-val11' placeholder="ZIP, City, Airport or Address" required>
                            </label>
                            <label for="input-val12"><span>Transfer Type</span>
                            <input type="text" name="transfer_type" id='input-val12' placeholder="ZIP, City, Airport or Address" required>
                            </label>
                            <div class="clearfix">
                                ...
                                <div class="wheel-date">
                                    ...
                                    <input  class="datetimepicker" name="arrival_date" id='input-val15' type="text" value="29 Jan">
                                    </label>
                                </div>
                                <div class="wheel-date">
                                    <span>Departure Date</span>
                                    <label for="input-val16" class="fa fa-calendar">
                                    <input class="datetimepicker" name="departure_date" id='input-val16' type="text" value="29 Jan">
                                    </label>
                                </div>
                                <div class="wheel-date">
                                    <span>Adult</span>
                            ...
                            <button class="wheel-btn" id="input-val18" type="submit">Book Now</button>
                            </label>
                        </form>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="wheel-header text-center marg-lg-t140 marg-lg-b340 marg-md-t140 marg-md-b140 marg-sm-t70 ">
                            ...
                            <h3>car <span>Booking</span>  Service</h3>
                        </div>
                    </div>
                </div>
            </div>
